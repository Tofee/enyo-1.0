...
nodeTag: "video",
create: function() {
this.inherited(arguments), this.srcChanged(), this.posterChanged(), this.showControlsChanged(), this.autoplayChanged(), this.loopChanged();
},
rendered: function() {
...
if (this.poster) {
var a = enyo.path.rewrite(this.poster);
this.setAttribute("poster", a);
...
var g = f._enyoOpener || this.getRootWindow();
delete f._enyoOpener;
var h = this.fetchWindow(b);
...
// palm/controls/image/RotatingImage.js
...
this.imageSrc ? this.applyStyle("background-image", "url(" + this.imageSrc + ")") : this.applyStyle("background-image", null);
},
create: function() {
this.inherited(arguments), this.imageSrcChanged();
}
});
